...
const createBenefitSchema = z.object({
  ...
  // Annual Leave
  leaveDaysEntitlement: z.number().int().nullable().optional(),
  leaveIncludesPublicHolidays: z.boolean().nullable().optional(),
  leaveIncreasesWithTenure: z.boolean().nullable().optional(),
  leaveMaxDays: z.number().int().nullable().optional(),
  leaveBuySellDays: z.boolean().nullable().optional(),
  leaveCarryOverDays: z.number().int().nullable().optional(),
  leaveBirthdayOff: z.boolean().nullable().optional(),
  leaveVolunteerDays: z.number().int().nullable().optional(),
  leaveChristmasClosureDays: z.number().int().nullable().optional(),
  // Sick Pay
  sickPayFullPayWeeks: z.number().int().nullable().optional(),
  sickPayHalfPayWeeks: z.number().int().nullable().optional(),
  sickPayPartialPayPercent: z.number().min(0).max(100).nullable().optional(),
  sickPayWaitingDays: z.number().int().nullable().optional(),
  sickPayAboveStatutory: z.boolean().nullable().optional(),
  // Maternity Pay
  maternityFullPayWeeks: z.number().int().nullable().optional(),
  maternityPartialPayWeeks: z.number().int().nullable().optional(),
  maternityPartialPayPercent: z.number().min(0).max(100).nullable().optional(),
  maternityTotalLeaveWeeks: z.number().int().nullable().optional(),
  maternityAboveStatutory: z.boolean().nullable().optional(),
  maternityKitDays: z.number().int().nullable().optional(),
  maternityGradualReturn: z.boolean().nullable().optional(),
  // Paternity Pay
  paternityFullPayWeeks: z.number().int().nullable().optional(),
  paternityPartialPayWeeks: z.number().int().nullable().optional(),
  paternityPartialPayPercent: z.number().min(0).max(100).nullable().optional(),
  paternityTotalLeaveWeeks: z.number().int().nullable().optional(),
  paternityAboveStatutory: z.boolean().nullable().optional(),
  paternitySharedParentalLeave: z.boolean().nullable().optional(),
