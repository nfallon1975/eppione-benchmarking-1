...
const benefitFormSchema = z.object({
  ...
  // Plan Design
  mandatoryClassification: z.string().nullable().optional().default(null),
  sumInsured: z.number().nullable().optional().default(null),
  sumInsuredCurrency: z.string().optional().default("EUR"),
  coverMultiple: z.number().nullable().optional().default(null),
  coverMultipleBase: z.string().nullable().optional().default(null),
  taxTreatment: z.string().nullable().optional().default(null),
  coverageScope: z.string().nullable().optional().default(null),
  insuredLives: z.number().int().nullable().optional().default(null),
  dependentCoverageType: z.string().nullable().optional().default(null),
  employeeEligibility: z.string().nullable().optional().default(null),
  eligibilityNotes: z.string().nullable().optional().default(null),
  deductibleAmount: z.number().nullable().optional().default(null),
  deductibleCurrency: z.string().optional().default("EUR"),
  coPayPercent: z.number().min(0).max(100).nullable().optional().default(null),
  coPayMaxAmount: z.number().nullable().optional().default(null),
  reimbursementPercent: z.number().min(0).max(100).nullable().optional().default(null),
  roomCategory: z.string().nullable().optional().default(null),
  hospitalLevel: z.string().nullable().optional().default(null),
  networkType: z.string().nullable().optional().default(null),
  benefitMaxAnnual: z.number().nullable().optional().default(null),
  benefitMaxCurrency: z.string().optional().default("EUR"),
  maternityNormalDelivery: z.number().nullable().optional().default(null),
  maternityCSection: z.number().nullable().optional().default(null),
  maternityCurrency: z.string().optional().default("EUR"),
  dentalAnnualMax: z.number().nullable().optional().default(null),
  dentalPreventiveCoverage: z.boolean().nullable().optional().default(null),
  dentalMajorCoverage: z.boolean().nullable().optional().default(null),
  visionAnnualMax: z.number().nullable().optional().default(null),
  visionExamCovered: z.boolean().nullable().optional().default(null),
  eliminationPeriodDays: z.number().int().nullable().optional().default(null),
  benefitDurationDays: z.number().int().nullable().optional().default(null),
  waitingPeriodDays: z.number().int().nullable().optional().default(null),
  isRider: z.boolean().optional().default(false),
  parentBenefitEntryId: z.string().nullable().optional().default(null),
  riderDescription: z.string().nullable().optional().default(null),
  brokerCommissionPercent: z.number().min(0).max(100).nullable().optional().default(null),
  brokerFee: z.number().nullable().optional().default(null),
  brokerFeeCurrency: z.string().optional().default("EUR"),
  carrierTerminationNoticeDays: z.number().int().nullable().optional().default(null),
  inMultinationalPool: z.boolean().optional().default(false),
  poolProviderName: z.string().nullable().optional().default(null),
  policyContractLength: z.number().int().nullable().optional().default(null),
  lastRenewalOutcome: z.string().nullable().optional().default(null),
});
        ...
        for (const [category, catData] of Object.entries(categories)) {
          ...
          for (const benefit of catData.benefits) {
            ...
            benefitEntries.push({
              ...
              // Plan Design
              mandatoryClassification: benefit.mandatoryClassification || null,
              sumInsured: benefit.sumInsured ?? null,
              sumInsuredCurrency: benefit.sumInsuredCurrency || "EUR",
              coverMultiple: benefit.coverMultiple ?? null,
              coverMultipleBase: benefit.coverMultipleBase || null,
              taxTreatment: benefit.taxTreatment || null,
              coverageScope: benefit.coverageScope || null,
              insuredLives: benefit.insuredLives ?? null,
              dependentCoverageType: benefit.dependentCoverageType || null,
              employeeEligibility: benefit.employeeEligibility || null,
              eligibilityNotes: benefit.eligibilityNotes || null,
              deductibleAmount: benefit.deductibleAmount ?? null,
              deductibleCurrency: benefit.deductibleCurrency || "EUR",
              coPayPercent: benefit.coPayPercent ?? null,
              coPayMaxAmount: benefit.coPayMaxAmount ?? null,
              reimbursementPercent: benefit.reimbursementPercent ?? null,
              roomCategory: benefit.roomCategory || null,
              hospitalLevel: benefit.hospitalLevel || null,
              networkType: benefit.networkType || null,
              benefitMaxAnnual: benefit.benefitMaxAnnual ?? null,
              benefitMaxCurrency: benefit.benefitMaxCurrency || "EUR",
              maternityNormalDelivery: benefit.maternityNormalDelivery ?? null,
              maternityCSection: benefit.maternityCSection ?? null,
              maternityCurrency: benefit.maternityCurrency || "EUR",
              dentalAnnualMax: benefit.dentalAnnualMax ?? null,
              dentalPreventiveCoverage: benefit.dentalPreventiveCoverage ?? null,
              dentalMajorCoverage: benefit.dentalMajorCoverage ?? null,
              visionAnnualMax: benefit.visionAnnualMax ?? null,
              visionExamCovered: benefit.visionExamCovered ?? null,
              eliminationPeriodDays: benefit.eliminationPeriodDays ?? null,
              benefitDurationDays: benefit.benefitDurationDays ?? null,
              waitingPeriodDays: benefit.waitingPeriodDays ?? null,
              isRider: benefit.isRider ?? false,
              parentBenefitEntryId: benefit.parentBenefitEntryId || null,
              riderDescription: benefit.riderDescription || null,
              brokerCommissionPercent: benefit.brokerCommissionPercent ?? null,
              brokerFee: benefit.brokerFee ?? null,
              brokerFeeCurrency: benefit.brokerFeeCurrency || "EUR",
              carrierTerminationNoticeDays: benefit.carrierTerminationNoticeDays ?? null,
              inMultinationalPool: benefit.inMultinationalPool ?? false,
              poolProviderName: benefit.poolProviderName || null,
              policyContractLength: benefit.policyContractLength ?? null,
              lastRenewalOutcome: benefit.lastRenewalOutcome || null,
              },
